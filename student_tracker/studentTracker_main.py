...
# Author:       Joe Lapinski
#
# Purpose:      Student Tracking Application. Demonstrating OOP, Tkinter GUI module,
...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        filemenu.add_command(label="Exit", underline=1,accelerator="Ctrl+Q",command=lambda: studentTracker_func.ask_quit(self))
