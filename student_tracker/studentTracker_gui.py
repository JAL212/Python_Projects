...
def load_gui(self):
    ...
    self.btn_update.grid(row=9,column=1,padx=(15,0),pady=(45,10),sticky=W)
    self.btn_delete = tk.Button(self.master,width=12,height=2,text='Delete',command=lambda: studentTracker_phonebook_func.onDelete(self))
